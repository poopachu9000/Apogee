...
function preload(){
  ...
  //camp1970IMG = loadImage("images/pills.png");
...
businessman = createSprite(140,2410,20,20)
...
mark7= createSprite(920,1800,20,200)
...
mark7.addAnimation("markIMG",markIMG);
